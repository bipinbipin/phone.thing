...
public class TakeAWSDL {
    ...
    // unknown creds
//    private String host = "10.100.5.131";
//    private String username = "AXLUser";
//    private String password = "qweqwe123$!";

    //original Greg / sean credentials
//    private String host = "10.0.1.80";
//    private String username = "Maskuser";
//    private String password = "boobs80085boobs";

    private String host = "10.100.5.60";
    private String username = "Maskuser";
    private String password = "boobs80085boobs";

    private String outputFile = "/etc/sample.response";
    private String inputFile = "/etc/sample.xml";
    ...
    public void execute() {
        try {
            ...
            while (currProp != null) {
                ...
                //Change this section to use the Object from the Input Page
                if (queryNode != null) {
                    // do the query
     ...
     public void executeUpdate(UpdateObject updObj) {
        try {
            // first, initialize the output file
            new FileWriter(outputFile).close();
            // now look through the source file for SQL statements
            ...
            while (currProp != null) {
                ...
                if (queryNode != null) {
                    ...
                    StringBuilder sb = new StringBuilder();
                        sb.append("update devicenumplanmap set e164mask='");
                        sb.append(updObj.getNewMask());
                        sb.append("' where fkdevice like (select pkid from device where name like '");
                        sb.append(updObj.getSepID());
                        sb.append("')");
